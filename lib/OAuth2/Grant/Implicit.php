...
class Implicit implements GrantTypeInterface {
    ...
    public function completeFlow($inputParams = null)
    {
        ...
        $authParams = AuthServer::getParam(array('client_id', 'redirect_uri', 'code'), 'post', $inputParams);
        ...
        $clientDetails = AuthServer::getStorage('client')->getClient($authParams['client_id'], null, $authParams['redirect_uri']);
